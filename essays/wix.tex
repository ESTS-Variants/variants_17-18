...
\contribution{
% Add full title
Born-Digital Manuscripts and the Contemporary Author. ``Carport'' from Marcel Beyer's Ezra Pound Poem Cycle, for Example
}
...
Born-Digital Manuscripts and the Contemporary Author.
}
...
\begin{figure}[H]
    \centering
    \frame{\includegraphics[width=.75\textwidth]{media/wix1.png}}
...
\begin{figure}[ph]
    \centering
    \frame{\includegraphics[width=.9\textwidth]{media/wix2.png}}
...
\begin{figure}[ph]
    \centering
    \frame{\includegraphics[width=.9\textwidth]{media/wix3.png}}
